              ...
              <div className="max-w-xl mx-auto w-full p-8 border-2 border-gray-200 rounded-3xl bg-white shadow-lg">
                 ...
                 <form onSubmit={handleSaveRestaurantProfile} className="space-y-6">
                   ...
                   <h4 className="text-lg font-black text-gray-900 mb-4">Printer Setup</h4>
                    <div>
                      <label className="block text-sm font-black text-gray-900 mb-2 uppercase">Print Server URL</label>
                      <input 
                       type="text" 
                       value={localRestaurantInfo.printServerUrl || ''} 
                       onChange={(e) => setLocalRestaurantInfo({...localRestaurantInfo, printServerUrl: e.target.value})}
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-2 font-bold">URL of the print server (LAN IP or tunnel). Use https:// for public tunnels.</p>
                    </div>
                    <div>
